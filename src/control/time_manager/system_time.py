...
class SystemTime(AbstractTime):
    ...
    def _refresh(self):
        self._time = QTime.currentTime()
        self.time_update_signal.emit(self._get_time_str())
...
class SystemTimeManager(AbstractTimeManager):
    ...
    def _init_time(self):
        ...
        self._time.time_update_signal.connect(self._on_received)  #信号连接
...
if __name__ == "__main__":
    ...
    time_manager._time.time_update_signal.connect(console_print)
